//Arduino/Teensy Flight Controller - TowerDrehm
//Author: Nicholas Rehm + Stefan Blandin
...
//Nick Rehm, author of DrehmFlight, from which TowerDrehm is heavily derived, asks you to credit him in any publications using
// this software and its derivatives.
...
// For TowerDrehm, these pins should be unused and a sbus capable receiver should be used instead.
